    ...
    return (
        <div className="w-full justify-center items-center  flex py-10">
            <div className="w-[88%] flex justify-between  flex-col gap-11 overflow-x-auto scrollbar-hide max-md:text-sm">
                ...
                <div className="flex justify-center items-center gap-6 text-center  overflow-x-auto snap-x snap-mandatory max-md:text-sm cursor-pointer">
                    {menu_list.map((item, index) => (
                        <div className="flex justify-center items-center flex-col gap-3 max-md:min-w-[70px]  " key={index}>
