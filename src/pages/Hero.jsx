    ...
    return (
        <div className="flex justify-center items-center w-full h-[91vh]">
            <div className="w-[88%]  items-center flex h-[81vh]  border-solid rounded-t-2xl  p-20 max-md:p-5 max-lg:p-14" style={{ backgroundImage: `url(${headerImg})`, backgroundSize: 'cover', backgroundPosition: 'center' }} >
                <div className="justify-between flex flex-col  gap-7 max-lg:gap-11 max-md:gap-8">
                    ...
                    <span className="text-[#fff] text-[22px] max-md:text-[18px] max-lg:text-[26px]">Craving something delicious? <br />  Order effortlessly with LuxBites – pure bite <br className="max-md:hidden" /> is a taste of perfection!, flavor in every bite.! 🚀🔥 </span>
                    <div>
